...
$${\rm loss} \left(f(x), {\rm true\ class\ of\ }x\right)$$

<br>
<br>

> **IF** all mistakes are equally bad:
$$\textrm {loss}(i, j) = \begin{cases}
1 & \textrm {if } i\neq j  \cr
0 & \textrm {if } i= j  \cr
\end{cases}$$
...
.pull-left[
<img src="img/fc.png" width="250px"/>
]
.pull-right[
<img src="img/mlp.png" width="400px"/>
]

--

<img src="img/loss.png" width="65%"/>
<img src="img/descent.gif" width="34%"/>
...
.left[
- Image: multi-dimensional single-information
- Text/Signals: sequential one-dimension priviledged single-information
]
---
